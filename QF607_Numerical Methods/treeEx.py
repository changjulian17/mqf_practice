...
def testKI2StepExample():
    S, r, vol = 100, 0.01, 0.2
    opt = EuropeanOption(1, 95, PayoffType.Call)
    kiPrice = binomialPricerX(S, r, vol, KnockInOption(0, 105, 0, 1, opt), 2, crrCalib)
    koPrice = binomialPricer(S, r, vol, KnockOutOption(0, 105, 0, 1, opt), 2, crrCalib)
    euroPrice = binomialPricer(S, r, vol, opt, 2, crrCalib)
    print("2 step kiPrice = ", kiPrice)
    print("2 step koPrice = ", koPrice)
    print("2 step euroPrice = ", euroPrice)
    print("2 step KIKO = ", kiPrice + koPrice)
