...
# ==============================================================================
# ENUMERATIONS AND BASIC PRICERS
# ==============================================================================
...
def oneStepBinomial(S:float, r:float, u:float, d:float, optType:PayoffType, K:float, T:float) -> float:
    """Calculates option price using a single-step binomial tree with explicit u/d factors."""
...
# Consistent Binomial Tree pricer - One Step
...
if __name__ == "__main__":
    testoneStepBinomialBS()
# Consistent Binomial Tree pricer - n Step
...
if __name__ == "__main__":
    crrBinomialGAmeEur()
# questions: 
# 1. why American Call is the same as Europen Call , for non-dividend paying stock? 
...
# ==============================================================================
# CALIBRATION MODELS (u, d, p calculation)
# ==============================================================================
